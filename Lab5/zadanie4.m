function [M,N,P,R,x_coarse,y_coarse,F_coarse,x_fine,y_fine,F_fine] = zadanie5()
	...
	M = 17; % liczba węzłów interpolacji wzdłuż osi X (stopień wielomianu zmiennej x: M-1)
	N = 17; % liczba węzłów interpolacji wzdłuż osi Y (stopień wielomianu zmiennej y: N-1)
